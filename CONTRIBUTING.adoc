# Contributing to karaf-features-openapi

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-openapi is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-openapi/issues/new/choose[issue form].
